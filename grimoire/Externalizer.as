package grimoire
{
	...
	public class Externalizer
	{
		...
		public function init(root:Root):void
		{
            ...
            this.addCallback("RejectDrop2", World.RejectDrop2);
            ...
            this.addCallback("ConnectTo", root.ConnectTo);
            this.addCallback("ConnectToProxy", root.ConnectToProxy);
			
			this.addCallback("getGameObject", root.getGameObject);
			this.addCallback("getGameObjectS", root.getGameObjectS);
			this.addCallback("setGameObject", root.setGameObject);
			this.addCallback("getArrayObject", root.getArrayObject);
			this.addCallback("setArrayObject", root.setArrayObject);
			this.addCallback("callGameFunction", root.callGameFunction);
			this.addCallback("callGameFunction0", root.callGameFunction0);
			this.addCallback("selectArrayObjects", root.selectArrayObjects);
			this.addCallback("isNull", root.isNull);
			this.addCallback("catchPackets", root.catchPackets);
			this.addCallback("sendClientPacket", root.sendClientPacket);
			
			this.addCallback("test", root.test);
